      ...
      <div className="timer-limit-controller-container">
        ...
        <div className="timer-limit-controller">
          ...
          <div className="limit-label-and-value-container">
            <p className="limit-label">{timeLimitInMinutes}</p>
          </div>
          <button
            className="limit-controller-button"
            disabled={isButtonIsDisabled}
    ...
    return (
      <div className="timer-controller-container">
        ...
        >
          ...
          >{isTimerRunning ? "pause" : "start"}</p>
        </button>
        <button className="timer-controller-btn" onClick={this.onResetTimer}
        type="button">
  ...
  return (
    <div className="app-container">
      ...
      <div className="digital-timer-container">
        ...
        <div className="controls-container">{this.renderTimerController()}
        {this.renderTimerLimitController()}</div>
      </div>
    </div>
  );
}
